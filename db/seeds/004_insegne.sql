...
--
-- GENERATO da config/chains.yaml: non modificarlo a mano.
...
JOIN (
  ...
  SELECT 'carrefour', 'carrefour', 'Carrefour', 'supermercato' UNION ALL
  ...
  SELECT 'deco', 'deco', 'Decò', 'supermercato' UNION ALL
  SELECT 'deco', 'deco-maxi', 'Decò Maxi', 'superstore' UNION ALL
  ...
  SELECT 'penny', 'penny', 'Penny', 'discount' UNION ALL
